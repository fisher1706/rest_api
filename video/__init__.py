...
engine = create_engine('sqlite://///home/oleg/PycharmProjects/rest_api/video/video.sqlite')
...
def setup_logger():
    ...
    file_handler = logging.FileHandler('/home/oleg/PycharmProjects/rest_api/video/log/api.log')
